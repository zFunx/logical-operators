...
const createOperand = (operand, variables, ops, results, updateConstant, rootUpdateConstant, updateVar, rootUpdateVar, delOp, parentkey, delArgOrConstant, numOfOperandsInParent, createConstant, createArg, createOp) => {
